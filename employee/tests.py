...
class EmployeeAPITests(APITestCase):
    ...
    def test_retrieve_employee(self):
        ...
        response = self.client.get(reverse('employee-retrieve-update-delete', kwargs={'pk': self.employee.pk}))
        print(response.data)  # Debug output
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    def test_update_employee(self):
      
        response = self.client.patch(reverse('employee-retrieve-update-delete', kwargs={'pk': self.employee.pk}), {
            "role": "ANALYST"  
        })
    ...
    def test_delete_employee(self):
        response = self.client.delete(reverse('employee-retrieve-update-delete', kwargs={'pk': self.employee.pk}))
        print(response.data)  # Debug output
